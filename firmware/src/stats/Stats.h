...
struct Stats {
    ...
    uint32_t serialRxBytesRead   = 0;
    uint32_t serialRxFramesDecoded = 0;
    uint32_t serialRxQueueFullEvents = 0;
    uint32_t serialRxQueueWaitMs = 0;
    uint32_t serialRxQueueMaxWaitMs = 0;
    uint8_t  serialRxQueueWaitActive = 0;
    uint32_t serialRxLastReadAgeMs = 0xFFFFFFFFu;
    uint16_t serialRxMaxAvail = 0;
    uint8_t  serialRxBacklogDepth = 0;
